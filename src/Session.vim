...
set shortmess=aoO
badd +35 src/parser.cpp
badd +42 src/shell.cpp
badd +1 src/main.cpp
badd +59 src/command.cpp
badd +1 src/header/command.h
badd +1 src/header/shell.h
badd +1 src/header/parser.h
badd +0 tests/single_command.sh
args src/parser.cpp
edit src/parser.cpp
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 59 - ((58 * winheight(0) + 33) / 67)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
59
...
1
normal! 0
tabedit tests/single_command.sh
set splitbelow splitright
wincmd t
set winheight=1 winwidth=1
argglobal
