...
nnoremap  l
nnoremap  o
vnoremap  :CtrlP /home/jt/Java/
nnoremap <silent>  :CtrlP
onoremap  :CtrlP /home/jt/Java/
vnoremap  :update
...
nnoremap <Right> :vertical resize +3
nnoremap <Left> :vertical resize -3
...
set ttimeoutlen=50
set updatetime=2000
set wildignore=*/tmp/*,*.so,*.zip,*/vendor/*,*/.git/*,*.swp,*.class,*.png,*.jpg,*.gif
set wildmode=list:longest,list:full
set nowritebackup
let s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
let v:this_session=expand("<sfile>:p")
silent only
cd ~/workspace/rshell/src
...
badd +1 main.cpp
badd +1 command.cpp
badd +1 header/command.h
badd +1 header/shell.h
badd +1 header/parser.h
args parser.cpp
edit parser.cpp
